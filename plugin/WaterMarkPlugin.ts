...
type IPosition = POSITION.lt | POSITION.lb | POSITION.rt | POSITION.rb | POSITION.full; // lt: top-left, lb: bottom-left, rt: top-right, rb: bottom-right, full: tiled (can be extended with more options in the future)
type IDrawOps = {
  text: string;
  size: number;
  fontFamily: string;
