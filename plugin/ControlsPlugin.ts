...
/**
 * Actual scenario: When scaling an object, Fabric.js uses a default precision of toFixed(2).
 * To achieve more accurate scaling, we've changed the default value of NUM_FRACTION_DIGITS to 4, i.e., toFixed(4).
 */
